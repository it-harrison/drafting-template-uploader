...
electron_1.ipcMain.on('store-token', (event, token) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (0, handleToken_1.encrypt)(token);
    const browserWindow = electron_1.BrowserWindow.fromWebContents(event.sender);
...
const csv_parse_1 = __webpack_require__(/*! csv-parse */ "./node_modules/csv-parse/dist/cjs/index.cjs");
...
function createIssue(ticketData, indices, errorData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function getPayload(ticketData, indices) {
    return {
        title: ticketData[indices.title],
        body: ticketData[indices.body],
        assignee: ticketData[indices.assignee],
        labels: (0, utilities_1.parseLabels)(ticketData[indices.labels]),
